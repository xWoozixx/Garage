    ...
    <body id="haut_de_page">
        <section class="contenu">
            ...
            <h1>Ajouter un Véhicule</h1><br>
                ...
                <input type="text" id="immatriculation" name="immatriculation" pattern="[0-9]{6}NC" placeholder="Ex: 123456NC" required>
                <span class="tooltiptext">Pour 1 000 NC renseigner 001000NC<br></span>
                </div>
                ...
                <input type="text" id="modele" name="modele" pattern="^[a-zA-Z0-9]{1,20}$" placeholder="Ex: Clio" required>
                <span class="tooltiptext">Uniquement des lettres et 20 max<br></span>
                </div>
                ...
                <input type="number" id="prixVente" name="prixVente" min="0" max="9999999999" step="1" placeholder="Ex: 1000000" required>
                <span class="tooltiptext">Uniquement un entier max: 9999999999<br></span>
                </div>
                ...
                <span class="tooltiptext">Optionnel</span>
                </div>
                <br>
