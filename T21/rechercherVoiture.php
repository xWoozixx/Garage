...
<body id="haut_de_page">
    <h1 class="titre_page">
        <div class="titre_important">Garage</div>
    </h1>
        ...
        <div>
            ...
            <form method="post" action="php/updateVehicule.php">
                ...
                <input type="text" id="modele" name="modele" value="<?php echo $modele; ?>"
                    pattern="^[a-zA-Z][0-9]{1,20}$" placeholder="Ex: Clio" required> Uniquement des lettres et 20
                max<br>
                ...
                <input type="number" id="prixVente" name="prixVente" value="<?php echo $prixVente; ?>" min="0"
                    max="9999999999" step="1" placeholder="Ex: 1000000" required>Uniquement un entier max:
                9999999999<br>

                <label for="dateEntreeGarage">Date d'entrée au garage :</label>
                <input type="date" id="dateEntreeGarage" name="dateEntreeGarage"
                    value="<?php echo $dateEntreeGarage; ?>" required><br>
                ...
                <input type="number" id="chevauxF" name="chevauxF" value="<?php echo $chevauxF; ?>" min="0" max="999"
                    placeholder="Ex: 5" required><br>

                <label for="description">Description :</label>
                <textarea id="description" name="description"
                    placeholder="Rapide description du véhicule"><?php echo $description; ?></textarea> Optionnel<br>
