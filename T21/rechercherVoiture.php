...
<body id="haut_de_page">
    <section class="contenu">
        <div>
            ...
            echo "<br><h1>Modifier le Véhicule immatriculé :<br><br> <strong>" . $immatriculation . "</strong></h1><br><br>";
            mysqli_close($conn);
            ?>

            <form method="post" action="php/updateVehicule.php">
                <input type='hidden' id="immatriculation" name="immatriculation" pattern="[0-9]{6}NC"
                    value="<?php echo $immatriculation; ?>" required>
                ...
                <input type="text" id="modele" name="modele" value="<?php echo $modele; ?>"
                    pattern="^[a-zA-Z][0-9]{1,20}$" placeholder="Ex: Clio" required>
                <small><br>Uniquement des lettres et 20 caractères max</small>
                <br><br><br>
                ...
                <input type="number" id="prixVente" name="prixVente" value="<?php echo $prixVente; ?>" min="0"
                    max="9999999999" step="1" placeholder="Ex: 1000000" required>
                <small><br>Uniquement un entier (max : 9999999999)</small>
                <br><br><br>

                <label for="dateEntreeGarage">Date d'entrée au garage :</label>
                <input type="date" id="dateEntreeGarage" name="dateEntreeGarage"
                    value="<?php echo $dateEntreeGarage; ?>" required>
                <br><br><br>

                <label for="chevauxF">Chevaux fiscaux :</label>
                <input type="number" id="chevauxF" name="chevauxF" value="<?php echo $chevauxF; ?>" min="0" max="999"
                    placeholder="Ex: 5" required>
                <small><br>Uniquement un entier (max : 999)</small>
                <br><br><br>

                <label for="description">Description :</label>
                <textarea id="description" name="description"
                    placeholder="Rapide description du véhicule"><?php echo $description; ?></textarea>
                <small><br>Optionnel</small>
                <br><br><br>
