...
<form method="post" action="php/addVehicule.php">
    ...
    <input type="text" id="immatriculation" name="immatriculation" pattern="[0-9]{6}NC" placeholder="Ex: 123456NC"
        required> Pour 1 000 NC renseigner 001000NC<br>
    ...
    <select name="marque" required>
        ...
        Vérifiez l'état de connexion sur les pages protégées : Sur les pages que vous souhaitez protéger, vous devez
        vérifier si l'utilisateur est connecté en vérifiant si la variable de session appropriée est définie.
        ...
        ?>
        Déconnexion de l'utilisateur : Pour permettre à l'utilisateur de se déconnecter, vous pouvez fournir un lien ou
        un bouton de déconnexion qui supprimera la session en cours.
        ...
        session_destroy();
        ?>
        Utilisez les informations de session : Sur les pages protégées, vous pouvez utiliser les informations de session
        pour personnaliser le contenu ou effectuer des opérations spécifiques à l'utilisateur connecté.
